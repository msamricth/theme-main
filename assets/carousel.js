        ...
        splide.on('moved', function () {
            ...
            if (activeSlide) {
                if (slider.classList.contains('is-in-view')) {
                    ...
                    var currentVisible = document.querySelectorAll('.is-visible');
                    ...
                    currentVisible.forEach(function (slide) {
                        lazyLoadImages(slide);
                    })
                    lazyLoadImages(activeSlide);
...
document.addEventListener('DOMContentLoaded', function () {
    get_slider();
    setTimeout(() => {
        var currentVisible = document.querySelectorAll('.splide__slide.is-visible');
        currentVisible.forEach(function (slide) {
            lazyLoadImages(slide);
        });
    }, 400);
