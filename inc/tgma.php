...
function theme_main_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'WP Bootstrap Blocks', // The plugin name.
			'slug'               => 'wp-bootstrap-blocks', // The plugin slug (typically the folder name).
			'source'             => 'https://github.com/liip/bootstrap-blocks-wordpress-plugin/archive/master.zip', // The plugin source.
