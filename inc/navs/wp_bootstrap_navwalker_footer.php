...
if (!class_exists('WP_Bootstrap_Navwalker_Footer_horizontal')) {
	/**
	 * WP_Bootstrap_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class WP_Bootstrap_Navwalker_Footer_horizontal extends Walker_Nav_Menu
	{
		/**
		 * Start Level.
		 *
		...
		public function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
		{
			...
			if (0 === strcasecmp($item->attr_title, 'divider') && 1 === $depth) {
				...
				//$item_underline = '<span class="nav-underline"></span>';
				$item_output .= $args->link_before . apply_filters('the_title', $item->title, $item->ID) . $args->link_after;
		...
		public static function fallback($args)
		{
			if (current_user_can('edit_theme_options')) {
				...
				$output .= '<li><a href="' . esc_url(admin_url('nav-menus.php')) . '" title="">' . esc_html__('Add a menu', 'supply') . '</a></li>';
				$output .= '</ul>';
				if ($container) {
